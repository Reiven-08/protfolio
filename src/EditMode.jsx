...
function AboutEditor() {
  ...
  return <section className="edit-home-editor" aria-label="About editor">
    ...
    <div className="edit-home-section"><h2>Instagram</h2><label>Instagram/social URL<input value={content.socialLinks.instagram} onChange={(event) => update('socialLinks', { ...content.socialLinks, instagram: event.target.value })} maxLength="1000" /></label></div>
